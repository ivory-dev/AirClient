...
public class Minecraft implements IThreadListener, IPlayerUsage
{
    ...
    private void startGame() throws LWJGLException, IOException
    {
        ...
        Air.INSTANCE.startup();
        
        if (this.serverName != null)
        {
            this.displayGuiScreen(new GuiConnecting(new AirClientMainMenu(), this, this.serverName, this.serverPort));
        }
        else
        {
            this.displayGuiScreen(new AirClientMainMenu());
        }
    ...
    public void displayGuiScreen(GuiScreen guiScreenIn)
    {
        ...
        {
            guiScreenIn = new AirClientMainMenu();
        }
        ...
        if (guiScreenIn instanceof AirClientMainMenu)
        {
