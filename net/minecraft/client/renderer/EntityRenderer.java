...
public class EntityRenderer implements IResourceManagerReloadListener
{
    ...
    private void frameInit()
    {
        ...
        if (this.mc.currentScreen instanceof AirClientMainMenu)
        {
            this.updateMainMenu((AirClientMainMenu)this.mc.currentScreen);
        }
    ...
    private void updateMainMenu(AirClientMainMenu p_updateMainMenu_1_)
    {
        try
        {
            String s = null;
            ...
            Field[] afield = AirClientMainMenu.class.getDeclaredFields();
